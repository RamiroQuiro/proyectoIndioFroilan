...
export default function CardProductos({
  ...
  return (
    <div className=" flex flex-col items-steck justify-center w-[300px] flex-auto h-[480px]  bg-white rounded-xl shadow-lg transform transition duration-300 hover:-translate-y-5 hover:shadow-2xl overflow-hidden">
      <div>
        <TituloCardProducto>{name}</TituloCardProducto>
        <DescripcionProducto>{categoria}</DescripcionProducto>
      </div>
      <img
        className="w-full cursor-pointer object-cover overflow-hidden h-full w-auto object-center"
        src={src}
        alt=""
      />
