...
export default function Footer() {
  return (
    <footer className="bg-white py-10 dark:bg-gray-900">
    <div className="container p-6 mx-auto">
        <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    <div>
                        <a href="#" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">RamaQuiro</a>
                    </div>

                    <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Mza 14 Lote 24 Barrio el Rincon - La Banda - Santiago del Estero.</p>
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">385535174</span>
                        <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">email@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Creado por RamaCode</p>
        </div>
    </div>
</footer>
  )
