...
export default function SectinBanner() {
  return (
    ...
    <div className=" px-6 py-10 mx-auto">
        <h1 className="text-3xl font-semibold font-sunday text-gray-800 capitalize my-5 lg:text-4xl dark:text-white">Eventos Recientes</h1>

        <div className="flex flex-col md:flex-row gap-y-10 flex-wrap">
            <div className="flex flex-auto md:w-1/2 flex-col md:flex-row justify-center align-center">
    ...
    />
    <SvgComponent
    className="fill-orange-600/70 absolute -left-72 md:-bottom-72 -bottom-96 skew-y-12 rotate-6 scale-50"
    />
    </Section>
  )
}
